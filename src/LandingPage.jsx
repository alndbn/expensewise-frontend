    ...
    <div className="landing-page">
      ...
      <main className="main-content">
        ...
        <p className="subtitle">
          The smartest way to track, analyze, and optimize your daily spending.
          Built for speed and clarity.
        </p>
        <ul className="features-list">
          <li>
            <strong>Instant Logging:</strong> Record your expenses on the go and
            see your balance update immediately.
          </li>
          <li>
            <strong>Custom Categorization:</strong> Organize your spending your
